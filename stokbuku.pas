...
begin
     ...
     Begin
           ADA :=FALSE;
           Readln(Berkas,kode,nama,harga,jumlah);
           Total := Harga * jumlah;
           ...
           begin
               ...
               Writeln(dummy,kode:5,nama:20,harga:10,jumlah:10);
           End;
           if not ada then
